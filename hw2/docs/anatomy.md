...
|---|--:|--:|--:|--:|--:|
| инференс | 4382 | 1478 | 1.00 | 6.8 | — |
| full fine-tune | 17004 | 3811 | 3.88 | 32.3 | 13.6807 |
| LoRA (r=8, q/v) | 5684 | 4473 | 1.30 | 7.9 | 13.6807 |
...
Колонка «Пик RSS» между режимами почти не меняется: разброс 2995 МБ на все три — и это при том, что full fine-tune обязан добавить к весам ещё 9845 МБ.
